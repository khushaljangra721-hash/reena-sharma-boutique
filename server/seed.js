...
यूट्यूब चैनल @Rehan09-wtr पर दिखाए जाने वाले सभी डिजाइन्स और कस्टम सिलाई हमारे बुटीक में 100% परफेक्ट फिटिंग के साथ उपलब्ध हैं।`,
  ...
  // 8. Flipkart-Style Verified Customer Reviews & Ratings
  const reviews = [
    {
      id: 'rev_1',
      productId: 'prod_st_1',
      productSlug: 'designer-heavy-gota-patti-suit-with-chiffon-dupatta',
      productName: 'Designer Heavy Gota Patti Suit with Chiffon Dupatta',
      userName: 'Pooja Sharma',
      userLocation: 'Mahendragarh, Haryana',
      rating: 5,
      title: 'Bilkul perfect fitting aur pure fabric!',
      comment: 'Maine YouTube video dekhkar boutique par naap diya tha. Masterji ne bahut hi sundar stitching ki hai. Latkan aur neck design exact photo jaisa bana hai. Highly recommended!',
    ...
    },
    {
      ...
      userLocation: 'Narnaul, Haryana',
      rating: 5,
      title: 'Family wedding ke liye best suit!',
      comment: 'Kapde ki quality bahut achi hai aur color ekdam bright hai. In-store trial me fit ekdam sahi aaya bina kisi alteration ke.',
      fitRating: 'Perfect Fit',
      fabricQuality: 'Superb Soft',
      images: [],
      isVerifiedBuyer: true,
    ...
    },
    {
      id: 'rev_3',
      productId: 'prod_bl_1',
      productSlug: 'padded-sweetheart-neck-saree-blouse-with-tassels',
      productName: 'Padded Sweetheart Neck Saree Blouse with Designer Latkan',
      userName: 'Neetu Jangra',
      userLocation: 'Rewari, Haryana',
      rating: 5,
      title: 'Padded cups fitting is 10/10',
      comment: 'Blouse ki cutting aur finishing boutique standard ki hai. Back tassels aur dori bohot elegant hain.',
      fitRating: 'Perfect Fit',
      fabricQuality: 'Superb Soft',
    ...
    },
    {
      id: 'rev_4',
      productId: 'prod_lh_1',
      productSlug: 'royal-bridal-semi-stitched-lehenga-choli-set',
      productName: 'Royal Velvet Embroidered Bridal Lehenga Set',
      userName: 'Sunita Yadav',
      userLocation: 'Mahendragarh',
      rating: 5,
      title: 'Bridal fitting ekdam flawless!',
      comment: 'Reena Sharma boutique se bridal lehenga customize karwaya. Can-can layer aur ghera bohot shandaar aaya hai.',
      fitRating: 'Perfect Fit',
      fabricQuality: 'Superb Soft',
  ...
  // 9. Live Stitching Orders Tracking Data
  const sampleOrders = [
    {
      id: 'ord_101',
      orderId: 'RSB-101',
      ...
      phone: '9876543210',
      itemDescription: 'Pastel Sharara Suit with Heavy Lace Work',
      stage: 'ready_for_pickup',
      expectedDate: '2026-08-28',
      masterNotes: 'Latkan attached, steam ironing complete. Ready for trial.',
      amount: 2499,
      advancePaid: 1000,
      createdAt: '2026-08-25T10:00:00.000Z',
    },
    {
      ...
      phone: '9812345678',
      itemDescription: 'Padded Silk Blouse with Sweetheart Neck',
      stage: 'stitching_in_progress',
      expectedDate: '2026-08-30',
      masterNotes: 'Cups attached, back dori piping underway.',
      amount: 1499,
      advancePaid: 500,
      createdAt: '2026-08-27T12:00:00.000Z',
    }
  ];
  db.setCollection('orders', sampleOrders);

  console.log('✅ Clean official boutique database prepared for 6 core categories + Reviews & Tracking!');
}
